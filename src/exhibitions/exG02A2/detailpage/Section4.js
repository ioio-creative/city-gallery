    ...
    useEffect(()=>{
        if(locationName){
            ...
            const CarsAnim = function(elem){
                ...
                this.player = null;
                this.numOfCars = 3;
                this.space = window.innerWidth * .1;//window.innerWidth* random(0.05, .1);
                // this.density = 0;
                    ...
                    for(let i=0; i<lth; i++){
                        ...
                        for(let c=0; c<carlth; c++){
                            ...
                            if(drivingInCar.pos.x - drivingInCar.width >= _this.space){
                                ...
                                _this.space = window.innerWidth * .1;//window.innerWidth* random(0.05, .1);
            ...
            <div id="right" className="half">
                <div className="wrap">
                    ...
                    <div ref={rightImageWrap} id="rightImageWrap" className="imageWrap">
                        <div id="rightTrain"><div style={{backgroundImage:`url(./images/exG02a/section4/${locationName ? locationName : 'hongkong'}train.svg)`,width:858/1920*100+'vw', height:564/1920*100+'vw'}}></div></div>
